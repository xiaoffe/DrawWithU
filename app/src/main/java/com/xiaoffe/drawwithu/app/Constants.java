...
//    public static final String KEY_API = "f95283476506aa756559dd28a56f0c0b"; //需要APIKEY请去 http://apistore.baidu.com/ 申请,复用会减少访问可用次数
    ...
    public static final class FragmentFactorConstant {
        public static final int FRAGMENT_ONLINES = 0;
        public static final int FRAGMENT_MYPROFILE = 1;
    }
    ...
    public static final String INVITE_DRAW = "invite_draw";
    public static final String REFUSE_DRAW = "refuse_draw";
    public static final String CLOSE_DRAW = "close_draw";
    public static final String CANCEL_DRAW = "cancel_draw";

    public static final String CLOSE_MIC_SPEAKER = "close_mic_speaker";
    public static final String OPEN_MIC_SPEAKER = "open_mic_speaker";
}