...
public class RippleView extends AppCompatButton {
    ...
    public RippleView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRippleColor = a.getColor(R.styleable.RippleView_ripple_Color,
                mRippleColor);
        mAlphaFactor = a.getFloat(R.styleable.RippleView_alpha_Factor,
                mAlphaFactor);
        mHover = a.getBoolean(R.styleable.RippleView_just_hover, mHover);
        a.recycle();
    }
