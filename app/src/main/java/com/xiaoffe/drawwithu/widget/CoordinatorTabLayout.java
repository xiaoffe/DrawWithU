package com.xiaoffe.drawwithu.widget;
...
//    }
    ...
    private class MyRollViewpagerAdapter extends StaticPagerAdapter {
        ...
        private int[] res={R.mipmap.pic4, R.mipmap.pic2,
                R.mipmap.pic3,R.mipmap.pic1};
        //等以后有闲情再改写为加载网络图片吧。。反正也不难
//        private String[] res = {
//              "https://www.zhuangbi.info//uploads//i//2016-01-27-bd6f1e1e31fea64f7f2f33ba31b0b1a2.gif",
//        "https://www.zhuangbi.info//uploads//i//2017-02-01-d3845f0993eb1956c7ee8f709024da3e.gif"
//        };
        ...
        public View getView(ViewGroup container, int position) {
            ...
            //从直接加载改写为Glide加载
            ImageLoader.load(container.getContext(),res[position], imageView);
//            imageView.setImageResource(res[position]);
    ...
    public interface LoadHeaderImagesListener {
        void loadHeaderImages(ImageView imageView);
    }
}
