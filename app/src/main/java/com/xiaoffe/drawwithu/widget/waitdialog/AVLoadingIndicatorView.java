package com.xiaoffe.drawwithu.widget.waitdialog;
...
public class AVLoadingIndicatorView extends View {
	...
	// BallClipRotatePulse, SquareSpin,
	// BallClipRotateMultiple, BallPulseRise, BallRotate, CubeTransition,
	// BallZigZag, BallZigZagDeflect,
	// BallTrianglePath, BallScale, LineScale, LineScaleParty,
	// BallScaleMultiple, BallPulseSync, BallBeat,
	// LineScalePulseOut, LineScalePulseOutRapid, BallScaleRipple,
	// BallScaleRippleMultiple, BallSpinFadeLoader,
	// LineSpinFadeLoader, TriangleSkewSpin, Pacman, BallGridBeat,
	// SemiCircleSpin })
